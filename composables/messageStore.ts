    ...
    const messages: Ref<MessageLog[]> = ref([
        {
            ...
            appeal: createPendingAppeal(createRawAppeal(), '...'),
            name: 'Leo',
            clazz: "MRD"
        },
        ...
        {type: DPType.gambling, dp: 2, date: '1691586729000', appeal: createRawAppeal(), name: 'Vincent', clazz: "MRD"},
        {
            ...
            dp: 1,
            date: '1688908329000',
            appeal: fulfillAppeal(createPendingAppeal(createRawAppeal(), '...'), 'idk'),
            name: 'Leo',
            clazz: "MRD"
        },
        {
        ...
        {
            type: DPType.pornography,
            dp: 12,
            date: '1682946729000',
            appeal: rejectAppeal(createPendingAppeal(createRawAppeal(), '...'), 'lol'),
            name: 'Hehe',
            clazz: "idk"
        },
    ].filter(value => {
